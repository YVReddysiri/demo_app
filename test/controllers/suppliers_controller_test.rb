...
class SuppliersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supplier" do
    assert_difference('Supplier.count') do
      post suppliers_url, params: { supplier: { supplier_id: @supplier.supplier_id, supplier_name: @supplier.supplier_name } }
    end
  ...
  test "should update supplier" do
    patch supplier_url(@supplier), params: { supplier: { supplier_id: @supplier.supplier_id, supplier_name: @supplier.supplier_name } }
